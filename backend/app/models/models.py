...
class Product(Base):
    ...
    amazon_seller_sku: Mapped[str | None] = mapped_column(String(100))
    ...
    asin_match_source: Mapped[str | None] = mapped_column(String(50))
    asin_match_evidence_json: Mapped[str | None] = mapped_column(Text)
...
class AplusUploadItem(Base):
    ...
    lingxing_aplus_id_hash: Mapped[str | None] = mapped_column(String(100))
    lingxing_status_text: Mapped[str | None] = mapped_column(String(100))
    amazon_draft_visibility: Mapped[str] = mapped_column(String(30), default="unconfirmed")
    draft_visible_at: Mapped[datetime | None] = mapped_column(DateTime)
    submitted_at: Mapped[datetime | None] = mapped_column(DateTime)
    publish_evidence_json: Mapped[str | None] = mapped_column(Text)
    source_task_run_id: Mapped[int | None] = mapped_column(Integer)
    source_task_step_id: Mapped[int | None] = mapped_column(Integer)
    product_aplus_id: Mapped[int | None] = mapped_column(Integer)
    aplus_content_fingerprint: Mapped[str | None] = mapped_column(String(100))
    seller_sku_used: Mapped[str | None] = mapped_column(String(100))
...
class AmazonCompetitorSearchCandidate(Base):
    ...
    detail_task_run_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("task_runs.id"))
    detail_task_step_id: Mapped[int | None] = mapped_column(Integer, ForeignKey("task_steps.id"))
    detail_captured_at: Mapped[datetime | None] = mapped_column(DateTime)
    brand: Mapped[str | None] = mapped_column(String(200))
    seller: Mapped[str | None] = mapped_column(String(200))
    category_rank: Mapped[str | None] = mapped_column(String(200))
    leaf_category: Mapped[str | None] = mapped_column(String(200))
    main_image_url: Mapped[str | None] = mapped_column(Text)
    ...
    capture_status: Mapped[str | None] = mapped_column(String(40))
    capture_error: Mapped[str | None] = mapped_column(Text)
    capture_raw_json: Mapped[str | None] = mapped_column(Text)
    final_selected: Mapped[int] = mapped_column(Integer, default=0)
    final_rank: Mapped[int | None] = mapped_column(Integer)
    final_score: Mapped[float | None] = mapped_column(Float)
    final_confidence: Mapped[str | None] = mapped_column(String(20))
    final_dimension_scores_json: Mapped[str | None] = mapped_column(Text)
    final_reason: Mapped[str | None] = mapped_column(Text)
    final_risks_json: Mapped[str | None] = mapped_column(Text)
    final_model: Mapped[str | None] = mapped_column(String(100))
    final_rule_version: Mapped[str | None] = mapped_column(String(100))
    final_raw_json: Mapped[str | None] = mapped_column(Text)
    final_selected_at: Mapped[datetime | None] = mapped_column(DateTime)
    imported_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.now)
    updated_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.now, onupdate=datetime.now)
