...
const configFixture = {
  ...
  aplus_image_api_mode: 'generations', aplus_image_generation_quality: 'high', aplus_image_aspect_ratio: '97:60',
  ...
  step1_material_download_mode: 'browser', step1_material_package_priority: 'Information',
  step1_price_missing_policy: 'manual_review',
  step1_material_missing_policy: 'manual_review', step1_allow_existing_materials: true,
  pricing_commission_rate: 0.10, pricing_return_rate: 0.04, pricing_insurance_rate: 0.025,
  pricing_insurance_payout_rate: 0.60, pricing_return_management_fee_rate: 0.20,
  pricing_return_management_fee_cap: 5, pricing_advertising_cost: 2,
  pricing_target_margin_rate: 0.15, pricing_min_profit: 5,
  step3_manual_login_on_auth_failure: false,
