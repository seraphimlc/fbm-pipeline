...
export interface Product {
  ...
  asin_match_source?: string | null;
  asin_match_evidence_json?: string | null;
...
export interface AplusUploadItem {
  ...
  lingxing_aplus_id_hash?: string | null;
  lingxing_status_text?: string | null;
  amazon_draft_visibility?: string | null;
  draft_visible_at?: string | null;
  submitted_at?: string | null;
  publish_evidence_json?: string | null;
  source_task_run_id?: number | null;
  source_task_step_id?: number | null;
  product_aplus_id?: number | null;
  aplus_content_fingerprint?: string | null;
  seller_sku_used?: string | null;
