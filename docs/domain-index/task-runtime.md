...
- A+ 自动触发 A1 policy：先看 `backend/app/services/aplus_auto_trigger.py` 和 `scripts/test_aplus_auto_trigger_a1_a2.py --stage a1`；A1 的 task-runtime 口径是只读检查 active task，不新增 task 创建路径。
